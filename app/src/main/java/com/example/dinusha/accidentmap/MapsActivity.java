package com.example.dinusha.accidentmap;
...
//            mMap.clear();
            ...
            myLocationMarker.title("My Location" + counter);

            if (counter < 1) {
//                mMap.addMarker(myLocationMarker);
                a.position(new LatLng(latitude, longitude));
                m = mMap.addMarker(a);
...
//        // Add a marker in Sydney, Australia, and move the camera.
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            Log.i("onpost execute", "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1111111111");
...
// Drawing polyline in the Google Map for the i-th route
            Log.i("poly lineeeee ", lineOptions.toString());
...
//            onPostExecute(data);
            Log.i("beforeonpost execute", "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1111111111");
        ...
        protected void onPostExecute(Object result) {
            Log.i("beforeonpost222execute", "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1111111111");
